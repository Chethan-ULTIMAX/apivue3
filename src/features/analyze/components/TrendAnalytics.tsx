...
export function TrendAnalytics({ hasData }: TrendAnalyticsProps) {
  return (
    <section>
      <Card className="overflow-hidden border-border bg-card/60">
        ...
        <CardContent className="p-5">
          {hasData ? <TrendReadyState /> : <TrendEmptyState />}
        </CardContent>
      </Card>
    </section>
  );
    ...
    <div className="relative flex min-h-[330px] items-center justify-center overflow-hidden rounded-xl border border-dashed border-border bg-muted/30 p-6">
      ...
      <div className="relative max-w-md text-center">
        ...
        <p className="mt-2 text-xs leading-5 text-muted-foreground">
          APIVue needs historical snapshots to calculate genuine trends. Once
          enough data exists, this chart will show how your activity changes
          over time.
        </p>
...
function TrendReadyState() {
  return (
    <div className="relative flex min-h-[330px] items-center justify-center overflow-hidden rounded-xl border border-border bg-muted/30">
      <div className="text-center">
        ...
        <p className="mx-auto mt-2 max-w-sm text-xs leading-5 text-muted-foreground">
          ...
          rendering a chart. The UI intentionally does not manufacture a trend
