...
async function startOwnershipVerification(platform: 'leetcode' | 'codewars', handle: string): Promise<OwnershipChallenge> {
  ...
  sessionStorage.setItem('apivue.ownership.challenge', JSON.stringify(challenge));
  return challenge;
}
