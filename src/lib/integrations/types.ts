...
export interface IntegrationDefinition {
  ...
  authType: 'oauth' | 'username' | 'coming-soon'; icon: LucideIcon; accent: string;
  handleLabel: string; handlePlaceholder: string; handleHint: string; headlineMetrics: string[]; metrics?: MetricDefinition[];
}
...
export interface ProfileData {
  ...
  highlights?: ProfileHighlight[]; breakdowns?: ProfileBreakdown[];
  privateAccess?: boolean; accessibleRepoCount?: number;
  repositories?: Array<{ name: string; url: string; private?: boolean; description?: string | null; language?: string | null; stars?: number; forks?: number; updatedAt?: string | null }>;
}
export interface TrackedProfile {
  id: string; platform: IntegrationId | string; username?: string; handle: string;
  displayName?: string; display_name?: string; avatarUrl?: string | null; avatar_url?: string | null;
  profileUrl?: string; profile_url?: string; pinned?: boolean; lastSyncedAt?: string; last_synced_at?: string;
  syncError?: string; sync_error?: string; data?: ProfileData;
}
