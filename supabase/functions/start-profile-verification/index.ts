...
Deno.serve(async (req) => {
  ...
  return json({ code, platform, handle, expiresAt, verificationMode: "webhook", webhookUrl, instructions: "Open Codewars Account Settings and add a webhook. Use the Payload URL shown here and this code as the webhook Secret. Save the webhook, then return to APIVue and click Check verification. You do not need to change your Clan or any profile information." });
});
